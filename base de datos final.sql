...
values('573485783','yhon','rivera','436425364','yhon@gmail.com','admin','admin123','2');
-- -----------------------------------------------------
-- Table `taller`.`moto`
-- -----------------------------------------------------
...
BEGIN
INSERT INTO venta(moto_idmoto,nombreServicio,precioServicio,nombreRepuesto,precioRepuesto) 
VALUES (vemoto_idmoto ,venombreServicio ,veprecioServicio,venombreRepuesto,veprecioRepuesto);
END$$
